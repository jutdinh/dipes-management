...
class Projects extends Model {
  ...
  static intFamily = ["INT", "INT UNSIGNED", "BIGINT", "BIGINT UNSIGNED"];
  ...
  constructor() {
    ...
    this.__addProperty__("project_name", Model.types.string, {
      required: true,
    });
    this.__addProperty__("project_code", Model.types.string);
    this.__addProperty__("project_status", Model.types.enum, {
      values: Projects.validStatus,
    });
    this.__addProperty__("project_description", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.__addProperty__("project_type", Model.types.enum, {
      values: ["database", "api"],
    });
    this.__addProperty__("proxy_server", Model.types.string, {
    ...
    this.__addProperty__("active_version", Model.types.string, {
      default: "v1",
    });

    this.__addProperty__("manager", Model.types.json);
    this.manager.__addProperty__("username", Model.types.string, {
      required: true,
    });
    ...
    this.members.__addProperty__("permission", Model.types.enum, {
      required: true,
      values: ["manager", "supervisor", "deployer"],
    });
    ...
    this.versions.__addProperty__("version_id", Model.types.int, {
      auto: true,
    });
    this.versions.__addProperty__("version_name", Model.types.string);
    this.versions.__addProperty__("create_by", Model.types.json);
    this.versions.create_by.__addProperty__("username", Model.types.string, {
      required: true,
    });
    ...
    this.versions.tables.foreign_keys.__addProperty__(
      "field_id",
      Model.types.int
    );
    this.versions.tables.foreign_keys.__addProperty__(
    ...
    this.versions.tables.__addProperty__("pre_import", Model.types.bool, {
      default: false,
    });

    this.versions.tables.__addProperty__("create_at", Model.types.datetime, {
      default: new Date(),
    });
    this.versions.tables.__addProperty__("create_by", Model.types.json);

    this.versions.tables.create_by.__addProperty__(
      "username",
      Model.types.string,
      { required: true }
    );
    ...
    this.versions.tables.__addProperty__("display_fields", Model.types.array, {
      default: [],
    }); // array of field_id
    this.versions.tables.__addProperty__("fields", Model.types.model);
    this.versions.tables.fields.__addProperty__("id", Model.types.int, {
      required: true,
    });
    this.versions.tables.fields.__addProperty__(
      "field_name",
      Model.types.string,
      { required: true }
    );
    ...
    this.versions.tables.fields.create_by.__addProperty__(
      "username",
      Model.types.string
    );
    this.versions.tables.fields.create_by.__addProperty__(
    ...
    this.versions.tables.fields.props.__addProperty__(
      "DATATYPE",
      Model.types.enum,
      { required: true, values: Projects.validTypes }
    );
    this.versions.tables.fields.props.__addProperty__(
      "NULL",
      Model.types.bool,
    ...
    this.versions.tables.fields.props.__addProperty__(
      "FILE_ACCEPT_TYPES",
      Model.types.array
    ); // array of strings which start with a dot, this one is prior
    ...
    this.versions.apis.__addProperty__("status", Model.types.bool, {
      default: true,
    });
    this.versions.apis.__addProperty__("description", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.versions.apis.__addProperty__("url", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.versions.apis.__addProperty__("remote_url", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.versions.apis.__addProperty__("api_method", Model.types.enum, {
      values: ["get", "post", "put", "delete"],
    });
    this.versions.apis.__addProperty__("api_scope", Model.types.enum, {
      values: ["private", "public"],
    });
    this.versions.apis.__addProperty__("create_at", Model.types.datetime, {
      default: new Date(),
    });
    ...
    this.versions.apis.field.__addProperty__("id", Model.types.int, {
      required: true,
    });
    this.versions.apis.field.__addProperty__("field_name", Model.types.string, {
      required: true,
    });
    this.versions.apis.field.__addProperty__(
      "fomular_alias",
      Model.types.string,
      { required: true }
    );
    this.versions.apis.field.__addProperty__("props", Model.types.json);
    this.versions.apis.field.props.__addProperty__(
      "DATATYPE",
      Model.types.enum,
      { required: true, values: Projects.validTypes }
    );
    this.versions.apis.field.props.__addProperty__("NULL", Model.types.bool, {
      default: false,
    });
    this.versions.apis.field.props.__addProperty__("LENGTH", Model.types.int, {
      default: Number.MAX_SAFE_INTEGER,
    });
    this.versions.apis.field.props.__addProperty__(
      "AUTO_INCREMENT",
    ...
    this.versions.apis.create_by.__addProperty__(
      "username",
      Model.types.string
    );
    this.versions.apis.create_by.__addProperty__(
    ...
    this.versions.apis.fields.__addProperty__(
      "display_name",
      Model.types.string
    );
    this.versions.apis.fields.__addProperty__(
    ...
    this.versions.apis.calculates.__addProperty__(
      "display_name",
      Model.types.string
    );
    this.versions.apis.calculates.__addProperty__(
    ...
    this.versions.apis.statistic.__addProperty__(
      "display_name",
      Model.types.string
    );
    this.versions.apis.statistic.__addProperty__(
    ...
    this.versions.apis.statistic.__addProperty__("fomular", Model.types.enum, {
      values: ["SUM", "AVERAGE", "COUNT"],
    });

    this.versions.__addProperty__("uis", Model.types.model);
    this.versions.uis.__addProperty__("ui_id", Model.types.int, { auto: true });
    this.versions.uis.__addProperty__("title", Model.types.string, {
      required: true,
    });
    this.versions.uis.__addProperty__("url", Model.types.string, {
      required: true,
    });
    this.versions.uis.__addProperty__("status", Model.types.bool, {
      default: true,
    });
    this.versions.uis.__addProperty__("params", Model.types.array);
    this.versions.uis.__addProperty__("type", Model.types.string, {
      default: "ui",
    });
    ...
    this.versions.uis.components.__addProperty__(
      "component_id",
      Model.types.int,
      { auto: true }
    );
    ...
    this.versions.ui.last_modified_by.__addProperty__(
      "username",
      Model.types.string
    );
    this.versions.ui.last_modified_by.__addProperty__(
    ...
    this.tasks.__addProperty__("period_name", Model.types.string, {
      default: "Giai đoạn mới",
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.tasks.__addProperty__("period_description", Model.types.string, {
      default: "Giai đoạn mới",
      maxLength: Number.MAX_SAFE_INTEGER,
    });

    this.tasks.__addProperty__("period_status", Model.types.enum, {
      values: Projects.validTaskStatus,
      default: 1,
    });
    this.tasks.__addProperty__("period_priority", Model.types.int, {
      default: 1,
    });
    this.tasks.__addProperty__("period_approve", Model.types.bool, {
      default: false,
    });
    ...
    this.tasks.tasks.__addProperty__("task_id", Model.types.int, {
      auto: true,
    });
    this.tasks.tasks.__addProperty__("task_name", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.tasks.tasks.__addProperty__("task_description", Model.types.string, {
      maxLength: Number.MAX_SAFE_INTEGER,
    });
    this.tasks.tasks.__addProperty__("task_status", Model.types.enum, {
      values: Projects.validTaskStatus,
      default: 1,
    });
    this.tasks.tasks.__addProperty__("task_priority", Model.types.int, {
      default: 1,
    });
    this.tasks.tasks.__addProperty__("task_approve", Model.types.bool, {
      default: false,
    });
    this.tasks.tasks.__addProperty__("is_new", Model.types.bool, {
      default: true,
    });
    ...
    this.tasks.tasks.__addProperty__("progress", Model.types.number, {
      default: 0,
    });

    this.tasks.tasks.__addProperty__("child_tasks", Model.types.model);
    this.tasks.tasks.child_tasks.__addProperty__(
      "child_task_id",
      Model.types.int,
      { auto: true }
    );
    ...
    this.tasks.tasks.child_tasks.__addProperty__(
      "child_task_status",
      Model.types.enum,
      { values: Projects.validTaskStatus, default: 1 }
    );
    this.tasks.tasks.child_tasks.__addProperty__("approve", Model.types.bool, {
      default: false,
    });
    this.tasks.tasks.child_tasks.__addProperty__("is_new", Model.types.bool, {
      default: true,
    });
    this.tasks.tasks.child_tasks.__addProperty__("priority", Model.types.int, {
      default: 1,
    });
    ...
    this.tasks.tasks.child_tasks.members.__addProperty__(
      "username",
      Model.types.string
    );
    this.tasks.tasks.child_tasks.members.__addProperty__(
    ...
    this.tasks.tasks.child_tasks.create_by.__addProperty__(
      "username",
      Model.types.string,
      { required: true }
    );
    ...
    this.tasks.tasks.task_modified.__addProperty__("id", Model.types.int, {
      auto: true,
    });
    this.tasks.tasks.task_modified.__addProperty__(
      "modified_by",
      Model.types.json
    );
    this.tasks.tasks.task_modified.modified_by.__addProperty__(
      "username",
      Model.types.string,
      { required: true }
    );
    ...
    this.tasks.tasks.task_modified.__addProperty__(
      "modified_what",
      Model.types.enum,
      { values: ["infor", "status", "approve", "other"] }
    );
    this.tasks.tasks.task_modified.__addProperty__(
      "old_value",
      Model.types.string,
    ...
    this.tasks.tasks.create_by.__addProperty__("username", Model.types.string, {
      required: true,
    });
    this.tasks.tasks.create_by.__addProperty__("fullname", Model.types.string);
    this.tasks.tasks.__addProperty__("create_at", Model.types.datetime, {
      default: new Date(),
    });

    this.__addProperty__("activation", Model.types.model);
    this.activation.__addProperty__("ACTIVATION_KEY", Model.types.string, {
      required: true,
      maxLength: 512,
    });
    this.activation.__addProperty__("MAC_ADDRESS", Model.types.string);
    this.activation.__addProperty__("ACTIVATE_AT", Model.types.datetime, {
      default: new Date(),
    });
  ...
  static generateProjectLine = (project_id) => {
    ...
    const splitted = uuid_format.map((length, index) => {
      ...
      if (previous != undefined) {
        const current = encryptedProjectId.slice(
          sumSlice(uuid_format, index),
          length + sumSlice(uuid_format, index)
        );
        return current;
      } else {
...
class ProjectsRecord extends Projects {
  ...
  getProjectAndManager = () => {
    ...
    supervisors.map((mem) => {
      mem.permission = Controller.permission.spv;
    });
    deployers.map((mem) => {
      mem.permission = Controller.permission.dpr;
    });

    project.members = [...supervisors, ...deployers];

    const currentVersion = project.versions[project.active_version]
      ? project.versions[project.active_version]
      : {};
  ...
  createMember = (users, username, role) => {
    const filtedUser = users.find(
      (u) => this.__dotDecode__(u.username) == username
    );
  ...
  addChildTask = async (period_id, task_id, childTask) => {
    ...
    data.tasks[`${period_id}`].tasks[`${task_id}`].child_tasks[`${id}`] =
      childTask;
    this.setData(data);
    return childTask;
  };
  ...
  makeAlias = async (primalName = "TÊN MỚI NÈ", format = "") => {
    ...
    const autoIncreID = await Database.getAutoIncrementId(
      stringifiedFirstChars
    );
  ...
  createFields = async (fields, creator) => {
    ...
    for (let i = 0; i < fields.length; i++) {
      if (fields[i].id == undefined) {
        const serializedField = await this.createField(
          this.formatRawFieldToFormedState(fields[i]),
          creator
        );
