...
export default () => {
    ...
    // Lắng nghe sự thay đổi của chế độ fullscreen
    useEffect(() => {
                    ...
                    <div class="col-md-12" style={{
                        ...
                        <div class="white_shd full" style={{
                            ...
                            <div class="full graph_head graph_head_cus d-flex">
                                ...
                                {
                                    fullScreen ?
                                        <FontAwesomeIcon icon={faMinimize} onClick={toggleFullscreen} className=" ml-2 size-32 pointer icon-fullscreen" title="Exit Full Screen" />
                                        :
                            ...
                            <div class={`table_section padding_infor_info_list_task ${fullScreen ? "height-960" : ""}`}
                                style={{
                                    display: "flex",
                                    flexDirection: "column",
                                    flexGrow: 1,
                                        ...
                                        <div class={`modal-dialog modal-dialog-center ${fullScreen ? "fake-model-bg" : ""}`}>
                                            <div class="modal-content">
                                                    ...
                                                    <form>
                                                        <div class="row">
                                                            <div class="form-group col-lg-12">
                                                                ...
                                                                <input type="text" class="form-control" value={stage.stage_name} onChange={
                                                            ...
                                                            <div class="form-group col-lg-12">
                                                                ...
                                                                <input type="text" class="form-control" value={stage.period_description} onChange={
                                                                        ...
                                                                        <div key={index} className="user-checkbox-item">
                                                                            <label className="pointer">
                                                                                <input
                                                                                    type="checkbox"
                                                                                    className="mr-1"
                                                                                    checked={selectedMemberTask.some(u => u.username === user.username)}
                                                                                    onChange={(e) => {
                                                                                        const selected = e.target.checked;
                                                                                        const updatedSelectedMembers = selected
                                                                                            ? [...selectedMemberTask, user]
                                                                                            : selectedMemberTask.filter(u => u.username !== user.username);
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" onClick={handleCloseModal} id="closeModalAddStage" data-dismiss="modal" class="btn btn-danger">{lang["btn.close"]}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
