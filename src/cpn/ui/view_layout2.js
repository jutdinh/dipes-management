                                    ...
                                    <div class="tabbar">
                                        <nav>
                                            <div class="nav nav-tabs" style={{ borderBottomStyle: "0px" }} id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile_s2" role="tab" aria-controls="nav-profile_s2" aria-selected="false"> <h5> {title || lang["ui.table_statis"]}</h5></a>
                                            </div>
                                        </nav>
                                    </div>
                                </div>
