                                ...
                                <form>
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" class="form-control" value={fieldTemp.task_name} onChange={
                                                (e) => { setFieldTemp({ ...fieldTemp, field_name: e.target.value }) }
                                            } placeholder="" />
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label>Khóa chính <span className='red_star'>*</span></label>
                                            <i class="fa fa-toggle-on" aria-hidden="true"></i>
                                        </div>
                                        <div class="form-group col-lg-6"></div>
                                        <div class="form-group col-lg-6">
                                            <label>Khóa ngoại<span className='red_star'>*</span></label>
