...
export const ValidTypeEnum = Object.freeze({
    ...
    INT_UNSIGNED: {
        id: 2, name: "INT UNSIGNED", type: "int", limit: {
            min: 0,
            max: 4294967295
        }, props: [{ name: "AUTO_INCREMENT", label: "Tự động tăng", type: "bool" }, { name: "PATTERN", friend: "AUTO_INCREMENT", type: "text", label: "Định dạng" }, { name: "MIN", label: "Giá trị tối thiểu", type: "int" }, { name: "MAX", label: "Giá trị tối đa", type: "int" }]
    },
    ...
    BIGINT: {
        id: 3, name: "BIGINT", type: "int", limit: {
    ...
    BIGINT_UNSIGNED: {
        id: 4, name: "BIGINT UNSIGNED", type: "int", limit: {
            min: 0,
    ...
    BOOL: {
        id: 5, name: "BOOL", type: "bool", limit: {
            min: 0,
            max: 1
    ...
    TEXT: { id: 11, name: "TEXT", type: "text", props: [{ name: "LENGTH", label: "Độ dài tối đa", type: "int" }] },
    CHAR: { id: 12, name: "CHAR", type: "char", props: [] }, /* Char( 255 ) */
    EMAIL: { id: 13, name: "EMAIL", type: "char", format: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, props: [] },
    ...
    FILE: {
        ...
        type: "file",
        limit: {
            minSize: 0, // Kích thước tối thiểu
            maxSize: 40 // Kích thước tối đa 49MB
        },
        props: [
            { name: "FILE_MAX_SIZE", label: "Kích thước tối đa", type: "int" }, // ví dụ: giới hạn kích thước file
            { name: "FILE_MULTIPLE", label: "Chọn nhiều tệp cùng lúc", type: "bool" },
            {
                name: "FILE_ACCEPT_TYPES", label: "Các định dạng được chấp nhận", type: "select", 
                options: [
                    { label: "Hình ảnh", value: ["png", "jpg", "jpeg"] },
                    { label: "Tài liệu", value: ["pdf", "xls", "xlsx", "doc", "docx", "zip"] }
                ]
            },
        ]
    },
    ...
    //     type: "password",
    //     props: [
    //         { name: "MIN_LENGTH", label: "Độ dài tối thiểu", type: "int" }, // ví dụ: độ dài tối thiểu
    //         { name: "COMPLEXITY", label: "Độ phức tạp", type: "text" } // ví dụ: yêu cầu chứa ký tự đặc biệt, số, chữ hoa
    //     ]
    // },
});
